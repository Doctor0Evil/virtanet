<XAI_Artifact artifact_id="e7b9a2f3-4c1d-4e9b-8f7a-5b2c3d4e5f6a" title="autonomous_opz.cs" contentType="text/csharp">
using System;
...
{
public string Name { get; set; }
public List<intellectualpropertyasset> Assets { get; set; } = new List<intellectualpropertyasset>();</intellectualpropertyasset></intellectualpropertyasset>
...
private readonly CancellationTokenSource _cts;</entity></datasource>
...
try
{
var response = await httpClient.GetAsync(source.Url, cancellationToken);
